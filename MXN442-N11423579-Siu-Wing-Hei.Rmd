...
set.seed(1)
logisticwithoutcross <- glm(Survived ~ Pclass + Sex + Age + SibSp + Parch + Nickname, 
                      data = process_train, 
                      family = binomial)
...
pred_value_logisticwithoutcross <- ifelse(pred_logisticwithoutcross > 0.5, 1, 0)
...
pred_logistick10 <- predict(logistick10, newdata = process_test)
...
pred_logistick5 <- predict(logistick5, newdata = process_test)
...
pred_logistick4 <- predict(logistick4, newdata = process_test)
...
set.seed(1)  
KNNwithoutcross <- kknn(Survived ~ Pclass + Sex + Age + SibSp + Parch + Nickname, train = process_train, test = process_test, k = 5)
...
KNNk10 <- train(Survived ~ Pclass + Sex + Age + SibSp + Parch + Nickname, 
                data = process_train, trControl = k10, method = "kknn",
                tuneGrid = expand.grid(kmax = 5,  distance = 2, kernel = "optimal"))  
...
KNNk5 <- train(Survived ~ Pclass + Sex + Age + SibSp + Parch + Nickname, 
                data = process_train, trControl = k5, method = "kknn",
                tuneGrid = expand.grid(kmax = 5,  distance = 2, kernel = "optimal"))  
...
KNNk4 <- train(Survived ~ Pclass + Sex + Age + SibSp + Parch + Nickname, 
                data = process_train, trControl = k4, method = "kknn",
                tuneGrid = expand.grid(kmax = 5,  distance = 2, kernel = "optimal"))  
...
## SVM with k-fold cross-validation (k=5)
...
## SVM with k-fold cross-validation (k=4)
...
cat("True Positives in Titanic NN (TP):", TP_nnwithoutcross, "\n")
cat("True Negatives in Titanic NN (TN):", TN_nnwithoutcross, "\n")
cat("False Positives in Titanic NN (FP):", FP_nnwithoutcross, "\n")
cat("False Negatives in Titanic NN (FN):", FN_nnwithoutcross, "\n")
```
...
cat("Accuracy of Titanic NN:", acc_nnwithoutcross, "\n")
cat("Precision of Titanic NN:", precision_nnwithoutcross, "\n")
cat("Recall of Titanic NN:", recall_nnwithoutcross, "\n")
cat("F1-Score of Titanic NN:", f1_nnwithoutcross, "\n")
```



## Neural Networks with k-fold cross-validation (k=10)
...
cat("True Positives in Titanic NN:", TP_nnwithk10, "\n")
cat("True Negatives in Titanic NN:", TN_nnwithk10, "\n")
cat("False Positives in Titanic NN:", FP_nnwithk10, "\n")
cat("False Negatives in Titanic NN:", FN_nnwithk10, "\n")
```
...
cat("Accuracy of Titanic NN:", acc_nnwithk10, "\n")
cat("Precision of Titanic NN:", precision_nnwithk10, "\n")
cat("Recall of Titanic NN:", reca_nnwithk10, "\n")
cat("F1-Score of Titanic NN:", f1_nnwithk10, "\n")
```
